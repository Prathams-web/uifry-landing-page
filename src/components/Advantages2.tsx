  ...
  return (
    <div className="flex flex-col lg:flex-row">
      <div className="lg:w-1/2 order-2 lg:order-1">
        <Image src="/assets/images/advantages2.svg" alt="App Screenshot" layout="responsive" width={600} height={600} />
      </div>
      <div className="lg:w-1/2 flex flex-col justify-center py-8 px-7 lg:pl-32 lg:pr-24 order-1 lg:order-2">
        <div className="flex flex-col mt-4">
          <div className="flex items-center">
            <Image src="/assets/icons/advantageslogo2.svg" alt="Notification Icon" width={40} height={40} />
