...
const Testimonial: FC = () => {
  return (
    <div className="flex flex-col items-center p-8">
      <h3 className="text-black font-semibold uppercase tracking-wider text-center">Testimonial</h3>
      ...
      <div className="flex flex-col md:flex-row items-center mt-8 w-full">
        <div className="w-full md:w-1/2 flex justify-center md:justify-center mb-8 md:mb-0">
          <Image src="/assets/images/testimonial.svg" alt="User Image" width={600} height={600} className="rounded-full" />
        </div>
        <div className="w-full md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left px-auto md:pr-15 lg:pr-20">
          ...
          <div className="mt-4 flex justify-center md:justify-start">
            <Image src="/assets/images/testimonials2.svg" alt="User Avatars" width={100} height={30} layout="fixed" />
          </div>
